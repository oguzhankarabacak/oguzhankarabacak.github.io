class UI{
    constructor(){
        ...
        this.forhata=document.getElementById("forhata");
    }
    clearInput(){
...
// </div>
        ...
        this.forhata.appendChild(div);

        setTimeout(()=>{
            div.remove();
        },2000) //2 saniye sonra hata kalkacak

    }

    //Repo Bilgileri
    showRepoInfo(repos){
        this.repoDiv.innerHTML="";  //önce içini temizliyoruz
...
// {/* <li class="list-group-item">asdaskdjkasjkşdjşasjd</li> */}
        if(users.indexOf(username) === -1){  //eğer önceden varsa eklemiyoruz
